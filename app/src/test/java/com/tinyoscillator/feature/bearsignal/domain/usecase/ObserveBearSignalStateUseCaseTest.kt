...
/**
 * [ObserveBearSignalStateUseCase] 화면 조립 상태 스트림 테스트 (TASK.md §2, Phase 4).
 *
...
class ObserveBearSignalStateUseCaseTest {
    ...
    private val compute = ComputeBearSignalUseCase()
    ...
    fun `period 기간 선택이 신호1 판정에 반영된다`() = runTest {
        ...
        val expectedMa = ComputeBearSignalUseCase.analyzeMarkets(BearSignalReportBaseline.MARKETS, 0)
