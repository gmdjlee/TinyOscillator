...
class HeatmapColorTest {
    ...
    fun `score above 0_75 maps to strong bull red`() =
        assertEquals(Color(0xFFD05540), heatmapColor(0.80f))
    ...
    fun `score between 0_40 and 0_59 maps to neutral gray`() =
        assertEquals(Color(0xFF8A8580), heatmapColor(0.50f))
    ...
    fun `score below 0_25 maps to strong bear blue`() =
        assertEquals(Color(0xFF4088CC), heatmapColor(0.20f))

    @Test
    fun `boundary 0_75 maps to strong bull`() =
        assertEquals(Color(0xFFD05540), heatmapColor(0.75f))

    @Test
    fun `boundary 0_40 maps to neutral`() =
        assertEquals(Color(0xFF8A8580), heatmapColor(0.40f))
